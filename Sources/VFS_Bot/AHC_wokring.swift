...
//
//    let solution_token = await cf_solution.heroAndreykaSolveCaptcha()
//
//    guard
//        let token_is_not_empty = solution_token["token"],
//        let token = token_is_not_empty
//    else {
...
//        let body: HTTPClient.Body = .data(data)
//
...
//        }
//
//        // Here should be your response body data
//        let res_data = Data(bytes)
//
//        if let jsonString = String(data: res_data, encoding: .utf8) {
//            print("Raw JSON string: \(response.status) \(jsonString) ")
...
//        ////            print("- /user/application Elapsed time: \(elapsedTime) seconds")
//        //        } else {
//        ////            let elapsedTime = Date().timeIntervalSince(startTime)
